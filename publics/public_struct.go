...
type HuaWei struct {
	Image    string `json:"/message/android/notification/image"`
	Style    int    `json:"/message/android/notification/style"`
	...
	UType int `json:"/message/android//message/android/target_user_type"`
}
...
type Honor struct {
	...
	TargetUType int `json:"/android/targetUserType"`
}
